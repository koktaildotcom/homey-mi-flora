...
class MiFloraDevice extends Homey.Device {
    ...
    _registerTriggers() {
        ...
        this.globalSensorTimeout = new Homey.FlowCardTrigger('sensor_timout');
    ...
    _generateHtml(document, deviceDisplay) {
        ...
        title.innerHTML = deviceDisplay.name + ' (' + deviceDisplay.lastUpdate + ')';
    ...
    buildHtmlChart() {
        ...
        const deviceDisplay = {
            'name': this.getName(),
            'lastUpdate': this.getSetting('last_updated'),
