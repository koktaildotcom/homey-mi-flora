...
class MiFloraDevice extends Homey.Device {
    ...
    buildHtmlCharts() {
        ...
        let borderColorDefault = '#e3e3e3';

        let widthDefault = 300;
        ...
        capabilities.forEach(function (capability) {
            if (conditionsMapping.hasOwnProperty(capability)) {
                ...
                for (let i = 0; i < parts.length; i++) {
                    ...
                    tdThreshold.style.backgroundColor = colorDefault;
                    tdThreshold.style.height = "3px";
                    tdThreshold.style.width = widthDefault + "px";
                    if (part.borderRight) {
                        tdThreshold.style.width = widthDefault - 1 + "px";
                ...
                flowerTable.appendChild(trThreshold);
                flowerTable.appendChild(tr);
                flowerTable.appendChild(trThreshold);
            }
        });
