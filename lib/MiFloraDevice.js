    ...
    buildHtmlCharts() {
        ...
        capabilities.forEach(function (capability) {
            if (conditionsMapping.hasOwnProperty(capability)) {
                ...
                flowerRow = document.createElement("table");
                flowerRow.cellPadding = 0;
                flowerRow.cellSpacing = 0;
                ...
                flowerRow.appendChild(tr);
                target.appendChild(flowerRow);
            }
        });
