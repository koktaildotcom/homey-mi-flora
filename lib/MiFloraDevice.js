            ...
            if (this._thresholdMapping.hasOwnProperty(capability)) {
                ...
                if (newSettingsObj.hasOwnProperty(mapping.min) && newSettingsObj.hasOwnProperty(mapping.max)) {
                    ...
                    if (minValue >= maxValue) {
                        callback(this.homey.__('settings.error.threshold', {"capability": this.homey.__('capability.' + capability + '.name')}), true);
                    }
                }
            }
        }
    ...
    _registerTriggers() {
        ...
        capabilities.forEach(function (capability) {
            if (this._conditionsMapping.hasOwnProperty(capability)) {
                this.homey.flow.getFlowCardCondition(this._conditionsMapping[capability])
