...
class MiFloraDriver extends Homey.Driver {
    ...
    async _handleUpdateSequence(device) {
        ...
        let peripheralConnected = function(){};
        ...
        try {
            ...
            return await Homey.app.discover(device)
                ...
                .then((service) => {
                    if(!service) {
                        throw new Error("No service found for (DATA_CHARACTERISTIC_UUID).");
                    }
                ...
                .then((service) => {
                    if(!service) {
                        throw new Error("No service found for (FIRMWARE_CHARACTERISTIC_UUID).");
                    }
