            ...
            return await Homey.app.discover(device)
                ...
                .then((peripheral) => {
                    ...
                    peripheral.discoverServices((error, services) => {
                        if (error) {
                            console.log('failed discoverServices: ' + error);
                        }
                        ...
                        if (services) {
                            services.forEach(function (service) {
                                service.discoverCharacteristics((error, characteristics) => {
                                    if (error) {
                                        console.log('failed discoverCharacteristics: ' + error);
                                    }
                                            ...
                                            switch (characteristic.uuid) {
                                                case DATA_CHARACTERISTIC_UUID:
                                                    characteristic.read(function (error, data) {
                                                        if (error) {
                                                            console.log('failed to read DATA_CHARACTERISTIC_UUID: ' + error);
                                                        }
                                                        ...
                                                        if (data) {
                                                            ...
                                                            console.log('No data found for sensor values.');
                                                        }
                                                    })
                                                    break
                                                case FIRMWARE_CHARACTERISTIC_UUID:
                                                    characteristic.read(function (error, data) {
                                                        if (error) {
                                                            console.log('failed to read FIRMWARE_CHARACTERISTIC_UUID: ' + error);
                                                        }
                                                        if (data) {
                                                            ...
                                                            console.log('No data found for firmware.');
                                                        }
                                                    });
                ...
                // .then((service) => {
                //     //console.log('service');
                //     // if already in realtime mode, return service
